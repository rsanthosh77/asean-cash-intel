...
<style>
@import url('https://apc01.safelinks.protection.outlook.com/?url=https%3A%2F%2Furldefense.com%2Fv3%2F__https%3A%2F%2Ffonts.googleapis.com%2Fcss2%3Ffamily%3DPlayfair*Display%3Awght%40400%3B700%3B900%26family%3DIBM*Plex*Mono%3Awght%40300%3B400%3B500%26family%3DIBM*Plex*Sans%3Awght%40300%3B400%3B500%3B600%26display%3Dswap__%3BKysrKys!!ASp95G87aa5DoyK5mB3l!_jKr_elyXb6KMQsuF4toUqxzwAVaAlmukxx4_cqeeG5VnC0SoAsXoMMEi7Emanr4z0bN9CdfYQCfh31jiDDl%24&data=05%7C02%7Ckumar.santhosh%40sc.com%7Cc3603335c09f4ce11d0b08de9e7aa80f%7Cb44900f12def4c3b9ec69020d604e19e%7C0%7C0%7C639122446836274784%7CUnknown%7CTWFpbGZsb3d8eyJFbXB0eU1hcGkiOnRydWUsIlYiOiIwLjAuMDAwMCIsIlAiOiJXaW4zMiIsIkFOIjoiTWFpbCIsIldUIjoyfQ%3D%3D%7C0%7C%7C%7C&sdata=tnJVyQPwLoasV6XJDPZynlWtuOqlI96rQrzGcwMrX2s%3D&reserved=0 ');
...
.mlbl { font-family:'IBM Plex Mono',monospace; font-size:9px; letter-spacing:.12em; color:var(--mu); text-transform:uppercase; margin-bottom:7px; -webkit-font-smoothing:antialiased; }
.mval { font-family:'Playfair Display',serif; font-size:28px; font-weight:700; color:var(--tx); line-height:1; margin-bottom:3px; }
.msub { font-family:'IBM Plex Mono',monospace; font-size:9px; color:var(--mu); -webkit-font-smoothing:antialiased; }
.mhint { font-family:'IBM Plex Mono',monospace; font-size:8px; letter-spacing:.08em; color:var(--mu); margin-top:5px; opacity:.7; }
...
.tag{font-family:'IBM Plex Mono',monospace;font-size:9px;letter-spacing:.04em;padding:2px 6px;border-radius:2px;text-transform:uppercase;-webkit-font-smoothing:antialiased;}
...
.sc-dt{font-family:'IBM Plex Mono',monospace;font-size:9px;color:var(--mu);-webkit-font-smoothing:antialiased;}
.sc-src-lnk{font-family:'IBM Plex Mono',monospace;font-size:9px;color:var(--blue);text-decoration:none;-webkit-font-smoothing:antialiased;}

/* ── Bar chart ── */
.bar-chart{display:flex;flex-direction:column;gap:6px;}
.bar-row{display:flex;align-items:center;gap:7px;}
.bar-lbl{font-family:'IBM Plex Mono',monospace;font-size:9.5px;color:var(--dim);width:80px;flex-shrink:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;-webkit-font-smoothing:antialiased;}
...
.bar-n{font-family:'IBM Plex Mono',monospace;font-size:9.5px;color:var(--mu);width:16px;text-align:right;}

/* ── Misc ── */
.sec-hdr{font-family:'IBM Plex Mono',monospace;font-size:9px;letter-spacing:.14em;color:var(--mu);text-transform:uppercase;padding:5px 0;border-bottom:1px solid var(--bd);margin-bottom:11px;-webkit-font-smoothing:antialiased;}
...
.stTabs [data-baseweb="tab"]{background:transparent !important;color:var(--mu) !important;font-family:'IBM Plex Mono',monospace !important;font-size:10.5px !important;letter-spacing:.08em !important;text-transform:uppercase !important;padding:10px 16px !important;border-bottom:2px solid transparent !important;-webkit-font-smoothing:antialiased !important;}
